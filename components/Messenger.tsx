        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-sm text-slate-100 flex items-center gap-1.5">
              Sam
              <span className="text-xs px-1.5 py-0.5 bg-slate-800 text-slate-400 rounded font-normal">Lead Data Strategist</span>
            </h3>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          >
            <div className="flex items-baseline gap-2 mb-1">
              <span className="text-xs font-medium text-slate-400">
                {m.sender === 'user' ? 'You (Junior Analyst)' : 'Sam'}
              </span>
        ...
        {isTyping && (
          <div className="flex flex-col items-start">
            <span className="text-xs font-medium text-slate-400 mb-1">Sam</span>
